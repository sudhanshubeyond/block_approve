define([
    ...
    return /** @alias module:block_programs/programs */ {
        ...
        reviews: function () {
            ...
            function bindFeedbackBoxToggle() {
                document.querySelectorAll('.clickable-feedback').forEach(trigger => {
                    const box = trigger.nextElementSibling;

                    trigger.addEventListener('click', (e) => {
                        e.stopPropagation();
                        document.querySelectorAll('.feedback-box').forEach(b => {
                            if (b !== box)
                ...
                if (page) {
                    ...
                    promises[0]
                            .done(function (data) {
                                ...
                                bindFeedbackBoxToggle(); // rebind click handlers to new content
                            })
